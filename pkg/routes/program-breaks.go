...
// @ID routes-get-program-brakes
// @Tags Блоки
// @Param body body models.SwaggerGetProgramBrakesRequest true  "Запрос"
// @Accept json
// @Produce json
// @Success 200 {object} models.StreamResponse
// @Router /api/v1/get-program-brakes [post]
func PostGetProgramBreaks(w http.ResponseWriter, r *http.Request) {
	...
	var request models.GetProgramBrakes
