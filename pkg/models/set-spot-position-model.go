...
type SetSpotPositionConfiguration struct {
	Cron    string `json:"cron"`
	Loading bool   `json:"loading"`
}

func (cfg *SetSpotPositionConfiguration) StartJob() error {
	if !cfg.Loading {
		return nil
	}
	qName := SetSpotPositionType
...
func (cfg *SetSpotPositionConfiguration) InitJob() func() {
	return func() {
		if !cfg.Loading {
			return
		}
